...
const WhoWeAre = () => {
  return <main className="p-8">
    <div className="mb-4">
      <h1 className="text-center text-6xl font-jidoka-newsreader">Who we are</h1>
    </div>
    <p className="max-w-4xl mx-auto text-justify">We are a nonprofit community dedicated to empowering aspiring
     developers through hands-on, project-based learning. We believe that real-world projects are the best way to
